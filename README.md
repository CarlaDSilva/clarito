...
**v1.4** — La contabilidad doméstica casi invisible.
...
### Despensa estimada
A partir del historial de compras, Clarito predice cuándo se agotará cada producto, separando lo urgente (7 días o menos) del resto. Reconoce alias y motes asignados a un producto para no duplicar entradas. También permite añadir productos manualmente o desde la lista de compras únicas, y exportar la lista de la compra a Recordatorios de iOS con un toque.
...
2. Pulsa el menú y selecciona "Instalar aplicación"
